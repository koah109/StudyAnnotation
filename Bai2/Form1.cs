...
namespace Bai2
{
    public partial class Form1 : Form
    {
        ...
        private TagImage _tagimage;
        private TagObject _tagObject;
        private MouseMode _mouseMode = MouseMode.Selected;
...

        {
...

            {
...

                {
                    ...
                    ImagePath = Path.GetFileNameWithoutExtension(pathImage),
            ...
            listImage.DataSource = _listtagimage;
            listImage.DisplayMember = "ImagePath";
            //UpdateListId();
        ...
        public void listImage_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            _tagimage = lstBox.SelectedItem as TagImage;

            boxImage.Image = new Bitmap(_tagimage.PathInput);

            _tagimage.ImageHeight = boxImage.Image.Height;

            _tagimage.ImageWidth = boxImage.Image.Width;
